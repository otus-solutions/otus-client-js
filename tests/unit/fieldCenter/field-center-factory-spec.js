(function () {
    ...
    describe('FieldCenterResourceFactory', function () {
        ...
        beforeEach(function () {
            ...
            angular.mock.inject(function (_$injector_) {
                factory = _$injector_.get('OtusFieldCenterResourceFactory');
                ...
                httpBackend.when(METHOD_POST_VALUE, REST_PREFIX + SUFFIX + UPDATE_SX).respond(200, DATA);                
            });
        });

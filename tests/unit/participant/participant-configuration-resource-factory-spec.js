(function () {
  ...
  describe('ParticipantProfileResourceFactory_UnitTest_Suite', function () {
    ...
    var PREFIX = 'http://localhost:8080/otus-rest/v01/participant-configuration';
    ...
    beforeEach(function () {
      ...
      angular.mock.inject(function (_$injector_) {
        factory = _$injector_.get('otus.client.ParticipantConfigurationResourceFactory');
        ...
        httpBackend.when(METHOD_POST_VALUE, PREFIX + SUB_SUFFIX).respond(200, DATA);
        httpBackend.when(METHOD_PUT_VALUE, PREFIX + SUB_SUFFIX).respond(200, DATA);
        httpBackend.when(METHOD_GET_VALUE, PREFIX + SUB_SUFFIX).respond(200, DATA);
      });
    });
